      ...
      <aside className="desktop-context">
        <div className="row gap-12" style={{ alignItems: "center" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: 11, color: "var(--color-text-subtle)", letterSpacing: "0.04em", textTransform: "uppercase", marginTop: 2, fontWeight: 600 }}>v1.0 · Mobile-first prototype</div>
          </div>
        </div>
